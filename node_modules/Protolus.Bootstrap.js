...
//require('cookies').apply(GLOBAL);
GLOBAL.System.crypto = require('crypto')
GLOBAL.System.cookies = require('cookies');
...
GLOBAL.System.mime = require('mime');
...
(function(){
    this.Protolus = {
        ...
        loadClass : function(name, path){
            ...
            console.log('['+AsciiArt.ansiCodes('CLASS', 'green')+']'+name);
            try{
        ...
        addEvent : function(type, callback){
            console.log('['+AsciiArt.ansiCodes('EVENT', 'yellow')+']'+type);
            switch(type){
                case 'web':
                    if(!Protolus.http) Protolus.http = require('http');
                    console.log('listening for web connection on '+Protolus.appPort)
